...
//  fModule.WriteModule(   RGN2_2::mid,   RGN2_2::Coin_coin_7      ,   0b1000011);
  ...
  fModule.WriteModule(   RGN2_2::mid,   RGN2_2::Coin_ctrl_7      ,   Region2_2_Coin.Coin7(Beam, SAC_or, TOF_or, LC_or, TOF_HT, Other4, Other5));
  fModule.WriteModule(   RGN2_2::mid,   RGN2_2::Coin_coin_7      ,   Region2_2_Coin.Ctrl7(Beam, SAC_or, TOF_or, LC_or, TOF_HT, Other4, Other5));
