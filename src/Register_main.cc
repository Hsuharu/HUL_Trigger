...
void Write( FPGAModule& module, unsigned int module_id, std::string name, unsigned int local_address, unsigned int write_data,unsigned int nread=1  )
{
  module.WriteModule( module_id, local_address, write_data );
  unsigned int ret = module.ReadModule( module_id, local_address, nread );
...
//    Write( fModule,LED::mid, LED::laddr_led, param("LED") );
  ...
  Write( fModule,   RGN3::mid,  "RGN3::PreScale_Beam_P    ",  RGN3::PreScale_Beam_P    ,        param("RGN3::PreScale_Beam_P")   -1 , 3);
